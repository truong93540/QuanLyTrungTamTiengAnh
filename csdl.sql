...
-- Name: BangThuong_ma_thuong_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
-- Dependencies: 233
-- Name: BangThuong_ma_thuong_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
-- Name: HoatDongNgoaiKhoa_ma_hoat_dong_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
-- Dependencies: 235
-- Name: HoatDongNgoaiKhoa_ma_hoat_dong_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
-- Name: BangThuong ma_thuong; Type: DEFAULT; Schema: public; Owner: -
--
...
-- Name: HoatDongNgoaiKhoa ma_hoat_dong; Type: DEFAULT; Schema: public; Owner: -
--
...
COPY public."ChuongTrinhMarketing" (ma_marketing, ten_chuong_trinh, noi_dung, ngay_bat_dau, ngay_ket_thuc, ngan_sach, ma_nhan_su) FROM stdin;
\.
...
COPY public."HoatDongNgoaiKhoa" (ma_hoat_dong, ten_hoat_dong, mo_ta, ngay_to_chuc, dia_diem, chi_phi, ma_nhan_su) FROM stdin;
\.
...
COPY public."HopDongLaoDong" (ma_hop_dong, so_hop_dong, ngay_ky, ten_cong_viec, tg_thu_viec, tg_nghi, update_at, ma_nhan_su, ma_phong_ban) FROM stdin;
\.
...
COPY public."NhanSu" (ma_nhan_su, ho_ten, ngay_sinh, gioi_tinh, so_dien_thoai, dia_chi, chuc_vu, ma_bang_cap) FROM stdin;
1	Nguyễn Văn Trường	\N	\N	0901234567	\N	\N	\N
2	Trần Thị Tuyển Sinh	\N	\N	0912345678	\N	\N	\N
3	Lê Hoàng Tài Chính	\N	\N	0923456789	\N	\N	\N
4	Vũ Thị Lan	\N	\N	0901234566	\N	Giảng viên	\N
5	Bùi Thế Anh	\N	\N	0901234567	\N	Nhân viên Marketing	\N
\.
...
COPY public."PhieuChi" (ma_phieu_chi, so_tien, ngay_chi, noi_dung, ma_phong_ban, ma_nhan_su) FROM stdin;
\.
...
COPY public."PhongBan" (ma_phong_ban, ten_phong_ban, mo_ta, ngay_thanh_lap) FROM stdin;
\.
...
COPY public."Quyen" (ma_quyen, ten_quyen, trang_thai) FROM stdin;
1	Admin	t
2	Quản lý tuyển sinh	t
3	Quản lý đào tạo	t
4	Quản lý tài chính	t
5	Xem báo cáo	t
\.
...
COPY public."TaiKhoan" (ma_tai_khoan, ten_dang_nhap, mat_khau, trang_thai, email, ma_quyen, ma_nhan_su) FROM stdin;
7	daotao_01	123456	t	truong93540@gmail.com	3	3
8	tuyensinh_01	123456	t	tuyensinh@hpenglish.vn	2	2
10	taichinh_01	123456	t	taichinh01@gmail.com	4	4
11	giamdoc_01	123456	t	giamdoc_1@gmail.com	5	5
9	admin_01	$2a$12$ady3jrsG2ihJDoS7V3t3muPihoxaAMpQSaRhIcx68WQsFYDQqnKEy	t	admin_01@gmail.com	1	1
\.
...
-- Dependencies: 233
-- Name: BangThuong_ma_thuong_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
-- Dependencies: 235
-- Name: HoatDongNgoaiKhoa_ma_hoat_dong_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
-- Name: BangLuong BangLuong_ma_nhan_su_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: BangThuong BangThuong_ma_bang_luong_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: BangThuong BangThuong_ma_nhan_su_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: ChuongTrinhKhuyenMai ChuongTrinhKhuyenMai_ma_khoa_hoc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: ChuongTrinhMarketing ChuongTrinhMarketing_ma_nhan_su_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: HoatDongNgoaiKhoa HoatDongNgoaiKhoa_ma_nhan_su_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: HocVien HocVien_ma_khoa_hoc_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: HopDongLaoDong HopDongLaoDong_ma_phong_ban_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: NhanSu NhanSu_ma_bang_cap_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: PhieuChi PhieuChi_ma_phong_ban_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: TaiKhoan TaiKhoan_ma_quyen_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
