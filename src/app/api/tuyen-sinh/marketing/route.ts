...
import { 
    layDanhSachChuongTrinh, layDanhSachNhanSuMarketing, 
    taoChuongTrinhMoi, capNhatChuongTrinh, xoaChuongTrinh 
...
export async function GET(request: Request) {
    try {
        ...
        if (action === 'get_marketing_staff') {
            const nhanSu = await layDanhSachNhanSuMarketing();
