                ...
                <div>
                    ...
                    <div className="mt-4 flex items-center gap-3 text-xs text-amber-800 bg-amber-50 px-4 py-2 rounded-lg border border-amber-100 w-fit shadow-sm">
                        ...
                        <a 
                            ...
                            download 
                            className="ml-2 px-3 py-1.5 rounded-lg bg-amber-600 text-white font-bold hover:bg-amber-700 transition-all text-[10px] uppercase tracking-wider shadow-md shadow-amber-100"
                        >
                            Xem file mẫu
                        </a>
                    </div>
